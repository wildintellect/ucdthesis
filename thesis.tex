...
% TODO: use the new subfig package instead, subfigure and subcaption conflict now
...
\usepackage[sorting=nyt,natbib=true,citestyle=authoryear,bibstyle=authoryear,maxnames=3,refsection=chapter,backend=bibtex]{biblatex}
...
% There are at least 2 different ways to include chapters
% chapter 1
